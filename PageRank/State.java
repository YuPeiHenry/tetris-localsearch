...
public class State {
	...
	//all legal moves - first index is piece type - then currentScore list of 2-length arrays
	...
	//possible orientations for currentScore given piece type
	...
	//make currentScore move based on the move index - its order in the legalMoves list
	public void makeMove(int move) {
		makeMove(legalMoves[nextPiece][move]);
	}
	
	//make currentScore move based on an array of orient and slot
	public void makeMove(int[] move) {
