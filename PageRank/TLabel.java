...
/**
 * Provided class for CS3243 project. Included only for completeness.
 */
...
public class TLabel{
	...
	//create currentScore frame, insert self in frame, then show self
	...
	// draw currentScore line from (x0, y0) to (x1, y1)
	public void line(double x0, double y0, double x1, double y1) {
//		System.out.println("drawing currentScore line from " + new Point(x0, y0).toString()+ " to " + new Point(x1,y1).toString());
	...
	// draw currentScore polygon with the given (x[i], y[i]) coordinates
...
//	draw currentScore polygon with the given (x[i], y[i]) coordinates
	...
	// draw currentScore filled polygon with the given (x[i], y[i]) coordinates
